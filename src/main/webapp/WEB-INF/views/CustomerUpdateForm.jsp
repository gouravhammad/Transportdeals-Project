...
<body> 
  <h1 style="Text-align:center; font-family: century gothic; color: green">CUSTOMER UPDATE FORM</h1>
  
  
	  <sf:form modelAttribute="customer" action="saveCustomerChanges" method="POST" enctype="multipart/form-data" >
	     <pre>
