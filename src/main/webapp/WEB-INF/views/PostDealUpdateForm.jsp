...
<body> 
  <h1 style="Text-align:center; font-family: century gothic; color: green">UPDATE DEAL</h1>
  
  
	  <sf:form modelAttribute="booking" action="saveDealChanges">
	     <pre>
	          Booking Code     : <sf:input type="number" path="bookingCode" /> <br>
